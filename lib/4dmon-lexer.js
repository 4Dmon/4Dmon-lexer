...
exports.Lexer = function() {
  ...
  // starts with a token they recognize. If they they return the *length* of the
  // token and put a reference to that token on this `this.tokens` stack by
  // making a call to `this.token`
  // -----------------------------------------------------
