...
(function() {
  ...
  exports.Lexer = function() {
    ...
    this.reservedToken = function() {
      ...
      if(FOURD_KEYWORDS_HASH.hasOwnProperty(candidate)) {
        tag = 'FOURD_KEYWORD';
        value = FOURD_KEYWORDS_HASH[candidate];
      }

      if(FOURD_CONSTANTS_HASH.hasOwnProperty(candidate)) {
        tag = 'FOURD_CONSTANT';
        value = FOURD_CONSTANTS_HASH[candidate];
      }
